...
public class ObjectFactory {
    ...
    private final static QName _GetBanksResponse_QNAME = new QName("http://wsdl/", "getBanksResponse");
    private final static QName _GetBanks_QNAME = new QName("http://wsdl/", "getBanks");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsdl/", name = "getBanksResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsdl/", name = "getBanks")
